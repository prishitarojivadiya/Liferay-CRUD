 ...
 */
@Generated("")
@GraphQLName(description = "Employee entity", value = "EmployeeDetails")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "EmployeeDetails")
public class EmployeeDetails implements Serializable {

	public static EmployeeDetails toDTO(String json) {
		return ObjectMapperUtil.readValue(EmployeeDetails.class, json);
	}

	public static EmployeeDetails unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(EmployeeDetails.class, json);
	}
	...
	@GraphQLField(description = "email address of employee")
	...
	@GraphQLField(description = "employee id.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected Long employeeId;

	@Schema(description = "employees first name")
	...
	@GraphQLField(description = "employees first name")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@GraphQLField(description = "employee Last name")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@GraphQLField(description = "mobile number")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@Schema(
		...
		defaultValue = "com.emp.dto.v1_0.EmployeeDetails", name = "x-class-name"
	)
